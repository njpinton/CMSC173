...
\centering
\includegraphics[width=0.75\textwidth]{../figures/activation_functions.png}
...
\centering
\includegraphics[width=0.75\textwidth]{../figures/activation_derivatives.png}
...
\textbf{Time Complexity:} $O(\text{number of weights})$
\begin{itemize}
\setlength{\itemsep}{0pt}
\item Same order as forward pass
\item Very efficient compared to numerical gradients
\item Enables training of large networks
\end{itemize}
\vspace{0.05cm}
\textbf{Space Complexity:} $O(\text{network size})$
\begin{itemize}
\setlength{\itemsep}{0pt}
\item Must store all activations
\item Memory scales with network depth
\end{itemize}
\end{block}
\end{column}
...
\item \textbf{Exact:} Computes exact gradients (no approximation)
...
\centering
\includegraphics[width=0.75\textwidth]{../figures/overfitting_regularization_demo.png}

\vspace{0.2cm}

\begin{alertblock}{Overfitting}
Model learns training data too well, \textbf{memorizing noise} instead of learning generalizable patterns.
\end{alertblock}
\end{frame}
...
\centering
\includegraphics[width=0.7\textwidth]{../figures/l1_vs_l2_regularization.png}
...
\vspace{0.05cm}
\begin{alertblock}{Best Practice}
Use dropout in \textbf{hidden layers only}, not in output layer. Start with rate 0.5 and tune based on validation performance.
\end{alertblock}
\end{frame}
...
\centering
\includegraphics[width=0.8\textwidth]{../figures/training_curves_regularization.png}

\vspace{0.2cm}

\begin{alertblock}{Monitoring Training}
Use \textbf{validation curves} to detect overfitting and choose appropriate regularization strength.
\end{alertblock}
\end{frame}
...
\end{columns}
\vspace{0.05cm}
\begin{alertblock}{Debugging Strategy}
\textbf{Start simple}: Small network, simple data. \textbf{Gradually increase complexity} while monitoring all metrics.
\end{alertblock}
\end{frame}
